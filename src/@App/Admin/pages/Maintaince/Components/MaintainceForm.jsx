	...
	return (
		<Box>
			<Box className="flex flex-wrap" sx={{ padding: 2 }}>
				...
				<Box className="flex flex-wrap w-full sm:flex-nowrap mb-16 sm:mb-20">
					<Box className="w-full sm:w-1/3 mt-12 mb-8 sm:mb-0">
						<Typography variant="h3" color="primary">
				...
				<Box className="m-10 border-1 w-full rounded-4 border-grey-300 min-h-full bg-grey-100">
					...
					<Box className="flex flex-wrap w-full">
						<Box className="sm:w-1/2 w-full my-8">
							...
							<Box className="pt-6 mt-5 ml-16  border-grey-300 border-1 rounded-l-4 bg-white min-h-min">
								<CoreCheckbox
									control={control}
				...
				<Box className="m-10 border-1 rounded-4 border-grey-300 min-h-full bg-grey-100">
					...
					<Box className="w-full mt-5">
						<Box className="flex flex-wrap w-full sm:w-11/12 pt-6 m-16 border-grey-300 border-1 rounded-l-4 bg-white min-h-min">
							<CoreCheckbox
								control={control}
